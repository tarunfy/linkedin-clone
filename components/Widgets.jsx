...
import img from "../public/widget.jpeg";
...
const Widgets = ({ articles }) => {
  return (
    <div className="hidden xl:inline space-y-2">
      ...
      <div className="bg-white dark:bg-[#1D2226] w-11/12 h-64 px-2.5 rounded-lg sticky t-20 border border-gray-300 dark:border-none">
