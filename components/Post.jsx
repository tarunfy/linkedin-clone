import { Avatar, IconButton, ModalManager } from "@mui/material";
...
const Post = ({ post, modalPost }) => {
  ...
  return (
    <div
      ...
      } space-y-2 py-2.5 border-gray-300 border dark:border-none`}
    >
      <div className="flex items-center px-2.5 cursor-pointer">
        <Avatar src={post.image} className="!h-10 !w-10 cursor-pointer" />
